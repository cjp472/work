...
Page({
  ...
  onLoad: function (options) {
    ...
    //获取一些参数
    wx.request({
      url: app.globalData.myUrl2 + 'minisoftware/jingCourse/getVipClass.do',
      data: {
  ...
  img: function () {
    ...
    wx.chooseImage({
      ...
      success: function (res) {
        ...
        // var sourseArr = that.data.sourseArr;
        for (var i = 0; i < res.tempFilePaths.length; i++){
          var sourseata = {
            'types': 2,
  ...
  titleInput: function (e) {
    this.data.titleInput = e.detail.value;
  },
  ...
  Return: function () {
    ...
    console.log(that.data.allClass[that.data.index].id);
    console.log(that.data.allClass[that.data.index].className);
    console.log(that.data.titleInput);
  ...
  gosave: function (arr) {
    ...
    wx.request({
      url: app.globalData.myUrl2 + 'minisoftware/tyHouTai/saveCourseNew.do',
      data: {
        "userid": app.globalData.userid,
        "khcode": app.globalData.khcode,
        "subTitle": that.data.titleInput,
        "subDetail": that.data.detailInput,
        "courseType": that.data.allClass[that.data.index].id+'',
        "joinType":"1",
        "timeStart": that.data.date,
        "timeEnd": that.data.date2,
